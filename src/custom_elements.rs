...
use crate::termin::{
    buffer::Rect,
    elements::{Element, Rectangle, Text},
    window::Position,
};
...
impl DialogBox {
    pub fn new(width: u32, height: u32) -> Self {
        Self {
            text_box: Text::default().size(width - 2, height - 2).xy(1, 1),
            rect: Rectangle::default().size(width, height),
        }
    }
    ...
    pub fn align_x(mut self) -> Self {
        self.text_box
            .set_position(self.rect.rect(), Position::CenterH);
        self
    }

    pub fn align_y(mut self) -> Self {
        self.text_box
            .set_position(self.rect.rect(), Position::CenterV);
        self
    }
    ...
    pub fn set_position(&mut self, rect: Rect, pos: Position) {
        ...
        self.text_box
            .set_position(self.rect.rect(), Position::Coord(1, 1));
    }
